...
export const ProductCard: FC<ProductCardProps> = memo(({ product, onAddToCart, onImageClick, onWatchVideo }) => {
    ...
    const hasSizeOptions = product.specs.some(spec =>
    ...
    // Compact card view for listing
    if (!showDetails) {
        return (
            <div className="product-card compact" onClick={() => setShowDetails(true)}>
                ...
                <div className="product-info-compact">
                    ...
                    <button className="btn-view-details" onClick={(e) => { e.stopPropagation(); setShowDetails(true); }}>
                        View Details
                    </button>
                </div>
            </div>
    ...
    return (
        <div className="product-detail-modal" onClick={() => setShowDetails(false)}>
            <div className="product-detail-content" onClick={(e) => e.stopPropagation()}>
                <button className="close-detail-btn" onClick={() => setShowDetails(false)} aria-label="Close">
                    <i className="fas fa-times"></i>
                </button>

                <div className="product-card full-detail">
                    <div className="product-tags">
                        <span className="tag category-tag">{product.category.join(' / ')}</span>
                        {product.originalPrice && <span className="tag sale-tag">Sale</span>}
                    </div>
